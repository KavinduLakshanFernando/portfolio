            ...
            <div className="hidden md:flex items-center space-x-8">
              {navItems.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-gray-300 hover:text-blue-400 px-3 py-2 text-lg transition-colors duration-300 relative group scroll-smooth"
                >
                  {item.name}
      ...
      >
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-base sm:text-lg text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0">
            I design and develop scalable web and mobile applications using MERN stack, Spring Boot, React, and React Native. My focus is on Full Stack, Backend, and Mobile App Development.
          </p>
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start mb-8">
            ...
            <a
              href="#contact"
              className="bg-gray-800 text-blue-400 px-6 py-3 rounded-lg border-2 border-blue-500 hover:bg-gray-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Contact Me
            </a>
          </div>
          ...
          <div className="flex gap-4 justify-center lg:justify-start">
            <a
              ...
              className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-300 hover:text-blue-400 hover:bg-gray-700 transition-all duration-300 shadow-md transform hover:scale-110 border border-blue-500"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-300 hover:text-green-400 hover:bg-gray-700 transition-all duration-300 shadow-md transform hover:scale-110 border border-blue-500"
            >
        ...
        <div className="flex-1 flex justify-center mt-12 lg:mt-0">
          <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96">
            ...
            <div className="absolute inset-3 bg-gray-800 rounded-full overflow-hidden border-4 border-blue-500 shadow-2xl">
              <img
            ...
            <div className="absolute -bottom-4 -right-4 bg-gray-800 px-4 py-2 rounded-full shadow-xl border-4 border-blue-500">
